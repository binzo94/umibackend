...
import MergebidAdd from "./mergebid-add";
  ...
  render() {
    ...
    if ('page' in Parse) {
      if(Parse.page === 'merge-add' )
        return <MergebidAdd fetchData={this.fetchMergeCompany}/>
      else{
      ...
      <React.Fragment>
        <Form inline>
          <Form.Item label="中标名称:">
            ...
            <Button type="primary" size="small" onClick={()=>{this.props.history.push({pathname:'/data-admin/mergebid-list',search:'page=merge-add'})}}>新增合并</Button>
